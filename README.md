...
* [配置介绍](#配置介绍)
  ...
  * [configs/oppo.gradle](#configsoppogradle)
  * [native](#native)
...
applyConfig('scripts/settings/oppo.gradle')
...
applyConfig('scripts/configs/oppo.gradle')
...
- aospDir: 通过 config.gradle 的 aospRoot 获取到 Android 源码的根目录。也可以自己配置源码所在的目录，如: aospDir = "/home/solo/code/oppo"。
...
oppo 代码所在的路径，主要是配置了 oppo-framework、oppo-services、oppo-framework-res等。

可以根据自己的需要修改 oppoDir 对应的目录即可。
