...
* [配置介绍](#配置介绍)
  ...
  * [configs-lineage.gradle](#configs-lineagegradle)
  * [native](#native)
...
applyConfig('scripts/settings/lineage.gradle')
...
applyConfig('scripts/configs/lineage.gradle')
...
- aospDir: 通过 config.gradle 的 aospRoot 获取到 Android 源码的根目录。也可以自己配置源码所在的目录，如: aospDir = "/home/solo/code/lineage"。
...
```
EXT_AOSP_ROOT=/Users/solo/code/lineage
```
