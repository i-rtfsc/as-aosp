...
* [配置介绍](#配置介绍)
  ...
  * [configs/miui.gradle](#configsmiuigradle)
  * [native](#native)
...
applyConfig('scripts/settings/miui.gradle')
...
applyConfig('scripts/configs/miui.gradle')
...
- aospDir: 通过 config.gradle 的 aospRoot 获取到 Android 源码的根目录。也可以自己配置源码所在的目录，如: aospDir = "/home/solo/code/miui"。
...
miui 代码所在的路径，主要是配置了 miui-framework、miui-services、miui-framework-res等。

可以根据自己的需要修改 miuiDir 对应的目录即可。
...
```
EXT_AOSP_ROOT=/Users/solo/code/miui
```
